...
import org.spiritconsortium.xml.schema.spirit._1685._2009.CellClassValueType;
 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CellClassTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CellClassTypeImpl#getCellStrength <em>Cell Strength</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CellClassTypeImpl extends MinimalEObjectImpl.Container implements CellClassType {
	...
	protected EClass eStaticClass() {
		return _2009Package.eINSTANCE.getCellClassType();
	}
	...
	public void setValue(CellClassValueType newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.CELL_CLASS_TYPE__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2009Package.CELL_CLASS_TYPE__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
	...
	public void setCellStrength(CellStrengthValueType newCellStrength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.CELL_CLASS_TYPE__CELL_STRENGTH, oldCellStrength, cellStrength, !oldCellStrengthESet));
	}
	...
	public void unsetCellStrength() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2009Package.CELL_CLASS_TYPE__CELL_STRENGTH, oldCellStrength, CELL_STRENGTH_EDEFAULT, oldCellStrengthESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2009Package.CELL_CLASS_TYPE__VALUE:
				return getValue();
			case _2009Package.CELL_CLASS_TYPE__CELL_STRENGTH:
