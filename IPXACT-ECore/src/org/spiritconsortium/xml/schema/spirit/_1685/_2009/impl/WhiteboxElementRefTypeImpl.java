 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.WhiteboxElementRefTypeImpl#getWhiteboxPath <em>Whitebox Path</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.WhiteboxElementRefTypeImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WhiteboxElementRefTypeImpl extends MinimalEObjectImpl.Container implements WhiteboxElementRefType {
	...
	protected EClass eStaticClass() {
		return _2009Package.eINSTANCE.getWhiteboxElementRefType();
	}
	...
	public EList<WhiteboxPathType> getWhiteboxPath() {
		if (whiteboxPath == null) {
			whiteboxPath = new EObjectContainmentEList<WhiteboxPathType>(WhiteboxPathType.class, this, _2009Package.WHITEBOX_ELEMENT_REF_TYPE__WHITEBOX_PATH);
		}
		return whiteboxPath;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.WHITEBOX_ELEMENT_REF_TYPE__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _2009Package.WHITEBOX_ELEMENT_REF_TYPE__WHITEBOX_PATH:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case _2009Package.WHITEBOX_ELEMENT_REF_TYPE__NAME:
				return getName();
		}
