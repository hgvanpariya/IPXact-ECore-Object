 ...
 * <ul>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getBitStringLength <em>Bit String Length</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getChoiceRef <em>Choice Ref</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getConfigGroups <em>Config Groups</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getDependency <em>Dependency</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getFormat <em>Format</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getId <em>Id</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getMaximum <em>Maximum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getMinimum <em>Minimum</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getOrder <em>Order</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getPrompt <em>Prompt</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getRangeType <em>Range Type</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getResolve <em>Resolve</em>}</li>
 *   <li>{@link org.spiritconsortium.xml.schema.spirit._1685._2009.impl.CommandLineSwitchTypeImpl#getAnyAttribute <em>Any Attribute</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CommandLineSwitchTypeImpl extends MinimalEObjectImpl.Container implements CommandLineSwitchType {
	...
	protected EClass eStaticClass() {
		return _2009Package.eINSTANCE.getCommandLineSwitchType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__VALUE, oldValue, value));
	}
	...
	public void setBitStringLength(BigInteger newBitStringLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__BIT_STRING_LENGTH, oldBitStringLength, bitStringLength));
	}
	...
	public void setChoiceRef(String newChoiceRef) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__CHOICE_REF, oldChoiceRef, choiceRef));
	}
	...
	public void setConfigGroups(List<String> newConfigGroups) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__CONFIG_GROUPS, oldConfigGroups, configGroups));
	}
	...
	public void setDependency(String newDependency) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__DEPENDENCY, oldDependency, dependency));
	}
	...
	public void setFormat(FormatType newFormat) {
		...
		formatESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__FORMAT, oldFormat, format, !oldFormatESet));
	}
	...
	public void unsetFormat() {
		...
		formatESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2009Package.COMMAND_LINE_SWITCH_TYPE__FORMAT, oldFormat, FORMAT_EDEFAULT, oldFormatESet));
	}
	...
	public void setId(String newId) {
		...
		id = newId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__ID, oldId, id));
	}
	...
	public void setMaximum(String newMaximum) {
		...
		maximum = newMaximum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__MAXIMUM, oldMaximum, maximum));
	}
	...
	public void setMinimum(String newMinimum) {
		...
		minimum = newMinimum;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__MINIMUM, oldMinimum, minimum));
	}
	...
	public void setOrder(float newOrder) {
		...
		orderESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__ORDER, oldOrder, order, !oldOrderESet));
	}
	...
	public void unsetOrder() {
		...
		orderESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2009Package.COMMAND_LINE_SWITCH_TYPE__ORDER, oldOrder, ORDER_EDEFAULT, oldOrderESet));
	}
	...
	public void setPrompt(String newPrompt) {
		...
		prompt = newPrompt;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__PROMPT, oldPrompt, prompt));
	}
	...
	public void setRangeType(RangeTypeType newRangeType) {
		...
		rangeTypeESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__RANGE_TYPE, oldRangeType, rangeType, !oldRangeTypeESet));
	}
	...
	public void unsetRangeType() {
		...
		rangeTypeESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2009Package.COMMAND_LINE_SWITCH_TYPE__RANGE_TYPE, oldRangeType, RANGE_TYPE_EDEFAULT, oldRangeTypeESet));
	}
	...
	public void setResolve(ResolveType newResolve) {
		...
		resolveESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, _2009Package.COMMAND_LINE_SWITCH_TYPE__RESOLVE, oldResolve, resolve, !oldResolveESet));
	}
	...
	public void unsetResolve() {
		...
		resolveESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, _2009Package.COMMAND_LINE_SWITCH_TYPE__RESOLVE, oldResolve, RESOLVE_EDEFAULT, oldResolveESet));
	}
	...
	public FeatureMap getAnyAttribute() {
		if (anyAttribute == null) {
			anyAttribute = new BasicFeatureMap(this, _2009Package.COMMAND_LINE_SWITCH_TYPE__ANY_ATTRIBUTE);
		}
		return anyAttribute;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__ANY_ATTRIBUTE:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__VALUE:
				return getValue();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__BIT_STRING_LENGTH:
				return getBitStringLength();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__CHOICE_REF:
				return getChoiceRef();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__CONFIG_GROUPS:
				return getConfigGroups();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__DEPENDENCY:
				return getDependency();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__FORMAT:
				return getFormat();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__ID:
				return getId();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__MAXIMUM:
				return getMaximum();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__MINIMUM:
				return getMinimum();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__ORDER:
				return getOrder();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__PROMPT:
				return getPrompt();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__RANGE_TYPE:
				return getRangeType();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__RESOLVE:
				return getResolve();
			case _2009Package.COMMAND_LINE_SWITCH_TYPE__ANY_ATTRIBUTE:
